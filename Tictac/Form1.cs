...
namespace Tictac
{
    public partial class Form1 : Form
    {
        ...
        public void getWinner()
        {
            ...
            if(btnLenght() == 9 && win == false)
            {
                label1.Text = "No winners";
            }
        ...
        public int btnLenght()
        {
            ...
            foreach (Control c in panel2.Controls)
            {
                if (c is Button)
                {
                    allTextLenght += c.Text.Length;
                }
            }
            return allTextLenght;
        }
        ...
        private void button10Game_Click(object sender, EventArgs e)
        {
            xor = 0;
            win = false;
            label1.Text = "Play";
